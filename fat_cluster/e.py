''' Inspect in the command line the evolution of the algorith in a case in
which after the execution of my algorithm, the most energy consuming layer is
not the closest to the  
'''
import numpy as np
